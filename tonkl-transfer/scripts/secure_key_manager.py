#!/usr/bin/env python3
"""
Tonkl Secure Key Manager -- HD key derivation with hardware-backed storage.

Phase 2 of the Tonkl key management architecture. Provides:
  ...
  3. Per-note spending key derivation with domain separation:
       ...
       sk_note = BLAKE3("Tonkl::note_sk_v1" || master_seed || note_index)
...
MASTER_SEED_LABEL = "tonkl_master_seed"
MNEMONIC_LABEL = "tonkl_mnemonic"
...
class SecureKeyManager:
    ...
    def derive_note_sk(self, note_index: int) -> bytearray:
        ...
        Formula:
            sk_note = BLAKE3("Tonkl::note_sk_v1" || master_seed || index)
                      mod BN254_P
...
def _cli():
    ...
    parser = argparse.ArgumentParser(
        description="Tonkl Secure Key Manager -- HD seed management"
    )
