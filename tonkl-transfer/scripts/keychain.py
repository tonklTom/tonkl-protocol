#!/usr/bin/env python3
"""
macOS Keychain integration for Tonkl spending key storage.
...
KEYCHAIN_SERVICE = "com.tonkl.wallet"
...
def store(label: str, sk_hex: str) -> None:
    ...
    Args:
        label:  Unique identifier for this key (e.g. "tonkl_in1_sk_<txid>")
...
def store_and_delete_after(label: str, sk_hex: str):
    ...
    Usage:
        with keychain.store_and_delete_after("tonkl_in1_sk", sk_hex):
            run_nargo(...)
    """
