#!/usr/bin/env python3
"""
macOS RAM disk manager for Tonkl key material handling.
...
Usage:
    ...
    if ramdisk.available():
        mount = ramdisk.create()                 # /Volumes/TonklRAM
...
def create(size_mb: int = 8) -> str:
    """
    Create a RAM disk and return its mount path (/Volumes/TonklRAM).
    ...
    Returns:
        Mount path string, e.g. "/Volumes/TonklRAM"
